module.exports = {
	...
	token: process.env.token || "OTU1ODQ5NzY4ODk3MjQ1MTk0.G3ur7b.MZYBxAVdPELJNWWnsRa4rtANLhLiEKSpOfIwMI", //- Bot's Token
	clientId: process.env.clientId || "955849768897245194", //- ID of the bot
	clientSecret: process.env.clientSecret || "POKhrxwOvtAaGAVmVIfIpV5-Qjmbmlns", //- Client Secret of the bot
	...
	nodes: [
		{
			...
			host: "lv.vellerius.tk", //- The host name or IP of the lavalink server.
			port: 2333, // The port that lavalink is listening to. This must be a number!
			password: "derpilava", //- The password of the lavalink server.
